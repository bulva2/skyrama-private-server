        ...
        if int(plane["id"]) == plane_id:
            ...
            if player_id == 0:
                ...
                if not in_buddy_list:
                    # Ints, not strings - buddy_invite writes ints and every consumer compares with ==
                    json_data["buddyStuff"]["buddies"].append({"lo_player_id": int(user_id), "hi_player_id": int(buddy_id), "status": 0, "buddy_points": buddy_points, "num_hits": 0, "task_visit": 0, "num_flights_today": 0, "todays_first_flight_time": 0, "todays_first_collected_passengers_time": 0, "todays_collected_passengers": 0, "received_passengers": 0, "last_ping_time": 1674583733, "last_buddyping_time": 0, "xp": json2_data["playerData"]["xp"], "online": 0, "location_id": json2_data["playerData"]["location_id"], "username": json2_data["playerData"]["user_name"]})
                    json2_data["buddyStuff"]["buddies"].append({"lo_player_id": int(buddy_id), "hi_player_id": int(user_id), "status": 0, "buddy_points": 0, "num_hits": 0, "task_visit": 0, "num_flights_today": 0, "todays_first_flight_time": 0, "todays_first_collected_passengers_time": 0, "todays_collected_passengers": 0, "received_passengers": 0, "last_ping_time": 1674583733, "last_buddyping_time": 0, "xp": json_data["playerData"]["xp"], "online": 0, "location_id": json_data["playerData"]["location_id"], "username": json_data["playerData"]["user_name"]})
